========================================================================
    KONSOLENANWENDUNG: Entwurfsmuster_Observer-Projektübersicht
========================================================================

Diese Entwurfsmuster_Observer-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Entwurfsmuster_Observer-Anwendung besteht.


Entwurfsmuster_Observer.vcxproj
...
Entwurfsmuster_Observer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Entwurfsmuster_Observer.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
