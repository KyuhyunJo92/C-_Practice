========================================================================
    KONSOLENANWENDUNG: Person_Anlage_Input_ouput-Projektübersicht
========================================================================

Diese Person_Anlage_Input_ouput-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Person_Anlage_Input_ouput-Anwendung besteht.


Person_Anlage_Input_ouput.vcxproj
...
Person_Anlage_Input_ouput.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Person_Anlage_Input_ouput.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
