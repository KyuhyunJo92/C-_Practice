========================================================================
    KONSOLENANWENDUNG: Person_Command_Pattern-Projektübersicht
========================================================================

Diese Person_Command_Pattern-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Person_Command_Pattern-Anwendung besteht.


Person_Command_Pattern.vcxproj
...
Person_Command_Pattern.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Person_Command_Pattern.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
