...
private : 
	...
	_SQLite_add_AddrCmd* c_sqliteaddAddr = new _SQLite_add_AddrCmd(pdb);
	...
	void execute()
	{
		...
		while (while_i)
		{
			...
			cout <<
				...
				"\n21.DB_insert_pers+addr  22.DB_search_persID  23.DB_add_Address"
				"\n==============================================================================="
			...
			case 22:
				...
				break;
			case 23:
				controller.setCmd(c_sqliteaddAddr);
				controller.pressButton();
				break;
			default:
				break;
