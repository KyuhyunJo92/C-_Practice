...
class Product_search
{
	...
	void execute()
	{
		...
		//select prod_id from produkt where like %keyword%
		//q1 : was moechten Sie tun? (1.see the detail of produkt 2.search with other keyword 3.go back to start Page)
		//q1-case1: auflufen - 'see produkt detail', Produkt_search_while = 0
...
{
	//input list number 
	//i think in this moment the view table function or virtual table function is necessary. 
	//in view table, i have to use v_prod_Nr.
