...
{
private :
	Sqlite3_search_Id_from_name * c_sqlite3Sea;
	PersonDB * pdb;
public:
	void execute() override
	{
		c_sqlite3Sea = new Sqlite3_search_Id_from_name();
...
{
private:
	Sqlite3_insert_Addr * c_sqlite3insAddr;
	PersonDB * pdb;
public:
	...
	void execute() override
	{
		c_sqlite3insAddr = new Sqlite3_insert_Addr(pdb);
...
private : 
	...
	_SQLite_search_Id_from_nameCmd* c_sqlite3Sea = new _SQLite_search_Id_from_nameCmd();
	
	_saveNewAddressCmd*		c_SaveNewAddr = new _saveNewAddressCmd(pdb);
	
	_SQLite_insert_AddrCmd* c_sqlite3insAddr = new _SQLite_insert_AddrCmd(pdb);
	/*
	...
	void execute()
	{
		...
		while (while_i)
		{
			...
			cout <<
				...
				"\n21.DB_insert_persInfo+addr 22.DB_search_persID   23.DB_regist_Address"
				"\n==============================================================================="
			...
			case 21:
				...
				break;
			case 22:
				controller.setCmd(c_sqlite3Sea);
				controller.pressButton();
				break;
			
			case 23:
				controller.setCmd(c_sqlite3insAddr);
				controller.pressButton();
			default:
				break;
			}
