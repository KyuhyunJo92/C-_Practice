	...
	void execute()
	{
		...
		else if (rc == SQLITE_OK)
		{
			char *sql = //"CREATE TABLE Cars(Id INT, Name TEXT, Price INT);"
						"INSERT INTO Cars(id, name, price) VALUES(?, 'Audi', 52642);"
						"INSERT INTO Cars(id, name, price) VALUES(?, 'Mercedes', 57127);"
						"INSERT INTO Cars(id, name, price) VALUES(?, 'BatMobile', 5000000)";
